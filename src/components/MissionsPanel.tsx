...
export const MissionsPanel: React.FC = () => {
    const { 
        ...
        openTimeAttackModal, completedCardIds
    } = useGameStore();
    ...
    const missionCards = [
        {
            id: 'shadow',
            title: 'Shadow Quest',
            subtitle: 'Observación en el Mundo Real',
            description: activeShadowQuest 
                ? `Misión activa: "${activeShadowQuest.mission.substring(0, 60)}..."`
                : 'Se genera automáticamente cada 5 cards completadas.',
            icon: <Eye size={24} />,
            color: 'text-primary',
            bgColor: 'bg-primary/10',
            active: !!activeShadowQuest,
            action: openShadowQuestModal,
            label: activeShadowQuest ? 'Reportar Hallazgos' : 'Pendiente de Generación',
            xp: 30
        },
        {
            id: 'mirror',
            ...
            description: activeMirrorMatch
                ? `Desafío activo: "${activeMirrorMatch.challenge.substring(0, 60)}..."`
            ...
            label: activeMirrorMatch ? 'Iniciar Debate' : 'Esperando Desafío',
            xp: 40
        },
        {
            id: 'timeattack',
            ...
            description: 'Pon a prueba tu agilidad mental con un desafío bajo presión.',
            icon: <Timer size={24} />,
            color: 'text-cyan-400',
            bgColor: 'bg-cyan-400/10',
            active: true,
            action: () => openTimeAttackModal(),
        ...
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] text-center px-6">
                ...
                <p className="text-white/40 max-w-sm text-sm font-medium">
                    Completa al menos 2 cards para empezar a recibir misiones y desafíos especiales.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="pb-32 pt-10 px-4 max-w-4xl mx-auto custom-scrollbar overflow-y-auto max-h-screen">
            <header className="mb-12">
                ...
                <p className="text-white/40 font-bold uppercase tracking-widest text-xs">Desafíos Especiales de Integración</p>
            </header>

            {/* Daily Quest always on top */}
            <DailyQuestBanner />

            <div className="space-y-6">
                <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 ml-2">Desafíos Disponibles</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {/* Placeholder for future mission types */}
                    <div className="rounded-[32px] border border-dashed border-white/5 flex flex-col items-center justify-center p-8 min-h-[280px]">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-white/10">Nuevos Desafíos Próximamente</p>
                    </div>
                </div>
            </div>
        </div>
